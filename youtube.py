...
def Api_connect():
    Api_id="AIzaSyD5LkagjdvE4aRmoxe8mCRWfEZKFiynjCY"
...
client=pymongo.MongoClient("mongodb+srv://swathika611:admin@yhswathika.nan524u.mongodb.net/?retryWrites=true&w=majority&appName=YHSwathika")
db=client["Youtube_data"]

def channel_details(channel_id):
    ch_details=get_channel_info(channel_id)
    pl_details=get_playlist_details(channel_id)
    vid_ids=get_vid_ids(channel_id)
...
def channels_table(channel_name_s):
    mydb = mysql.connector.connect(user='root', password='swathika', host='127.0.0.1',port=3306,database='youtube_data',
...
question=st.selectbox("Select your question",("1. All videos and corresponding channel names",
...
if question=="1. All videos and corresponding channel names":
